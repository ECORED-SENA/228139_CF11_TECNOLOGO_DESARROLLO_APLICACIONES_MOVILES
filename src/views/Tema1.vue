  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-4
      .col-lg-7.mb-2
        ...
        p UML por sus siglas en inglés (#[i Unified Modeling Language]), lenguaje unificado de modelado, es el lenguaje de modelado de sistemas de #[i software] más conocido y utilizado en la actualidad; permite visualizar, especificar, construir y documentar sistemas con una perspectiva orientada a objetos (Rumbaugh et al., 2004).    
    ...
    .row.justify-content-center
      .col-lg-11.col-12
        .titulo-sexto.color-acento-contenido
          h5 Figura 1.
          span Usos del modelado         
        figure.mb-5
          img(src='@/assets/curso/infografia-tema1.svg', alt='Se presentan cuatro usos fundamentales del modelado.') 
